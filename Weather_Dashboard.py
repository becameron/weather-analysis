...
precip_graph = pd.read_csv('Resources/precipitation_data.csv')
#temp_graph = pd.read_csv('Resources/temperature_data.csv')
temp_df = pd.read_csv('Resources/temperature_data.csv')
